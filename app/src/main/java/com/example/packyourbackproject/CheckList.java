...
import com.example.packyourbackproject.Adapter.CheckListAdapter;
        ...
        switch (item.getItemId()){
            ...
            case R.id.btnDeleteDefault:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are you sure? \n\nAs this will delete the data provider by ( Pack Your Bag ) while installing.")
            ...
            case R.id.btnReset:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are ypu sure?\n\nAs this will load the default data provider by ( Pack You Bag ) and will delete the custom data you have added in ( "+header+" )")
                        .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
